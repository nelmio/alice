...
final class TokenType
{
    ...
    const SIMPLE_REFERENCE_TYPE = 'REFERENCE_TYPE';
    const LIST_REFERENCE_TYPE = 'REFERENCE_TYPE';
    const WILDCARD_REFERENCE_TYPE = 'REFERENCE_TYPE';
    const RANGE_REFERENCE_TYPE = 'REFERENCE_TYPE';
